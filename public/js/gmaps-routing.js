...
initialize = function(){
  $('#departure').val('Paris');
  $('#arrival').val('Domaine de Sarson');

  var latLng = new google.maps.LatLng(44.43873, 4.87172); // Correspond au coordonnées de Lille
  var myOptions = {
...
calculate = function(){
    departure      = document.getElementById('departure').value; // Le point de départ
    arrival = document.getElementById('arrival').value; // Le point d'arrivée
